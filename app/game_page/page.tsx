...
export default function GamePage() {
  ...
  const leaderboardSentRef = useRef(false);
  ...
  const sendLeaderboardRequest = async () => {
  if (leaderboardSentRef.current) return
  leaderboardSentRef.current = true // prevent duplicate calls
  ...
  console.log("⏰ Sending leaderboard request with token...")
  ...
  try {
    ...
    console.error("❌ Failed to send leaderboard request:", err)
  }
}
